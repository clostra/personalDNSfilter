...
public class DNSResolver implements Runnable {
	...
	private UDPV4Packet udpRequestPacket;
	...
	public DNSResolver(DatagramSocket dnsSocket, UDPV4Packet udpRequestPacket, OutputStream reponseOut) {
	...
	private void processIPPackageMode() throws Exception {
		...
		String clientID = InetAddress.getByAddress(Utils.intToByteArray(sourceIP)).getHostAddress() + ":" + sourcePort;
		...
		UDPV4Packet udp = new UDPV4Packet(buf, 0, hdrLen + response.getLength());
